...
## Project Structure
    ...
    ├── testapiautosetting_125121  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125121`
...
2. Clone this repo and `cd testapiautosetting_125121`
